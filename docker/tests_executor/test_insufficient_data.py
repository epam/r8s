...
from commons.constants import ACTION_ERROR, STATUS_ERROR
...
class TestInsufficientData(BaseExecutorTest):
    def setUp(self) -> None:
        super().setUp()

        self.instance_id = 'insufficient_data'

        length = POINTS_IN_DAY // 2
    ...
    def test_insufficient_data(self):
        ...
        self.assert_action(result=result, expected_actions=[ACTION_ERROR])

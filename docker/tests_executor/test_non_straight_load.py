...
class TestNonStraightLoad(BaseExecutorTest):
    def setUp(self) -> None:
        ...
        self.instance_id = 'non_straight_load'
        ...
        cpu_load_series = generate_scheduled_metric_series(
            ...
            work_kwargs=dict(loc=80, scale=3),
            idle_kwargs=dict(loc=20, scale=1)
        )
        ...
        net_output_load_series = generate_scheduled_metric_series(
            ...
            work_kwargs=dict(loc=20, scale=3),
    ...
    def test_non_straight_load(self):
        ...
        self.assert_action(result=result, expected_actions=[ACTION_SPLIT])

...
build_helm_values() {
  ...
  echo -n "--set=modular-service.modularSdk.serviceMode=saas,modular-service.modularSdk.awsRegion=${modular_region},modular-service.modularSdk.assumeRoleArn=${MODULAR_SDK_ROLE_ARN//,/\\,} --set=modularSdk.serviceMode=saas,modularSdk.awsRegion=${modular_region},modularSdk.assumeRoleArn=${MODULAR_SDK_ROLE_ARN//,/\\,} --set=rightsizer.service_mode_s3=saas,modularSdk.modular_secrets_service_mode=saas,modularSdk.dbBackend=mongo"
}

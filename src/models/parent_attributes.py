...
class ResourceGroupAttribute(MapAttribute):
    allowed_resource_groups = \
        ListAttribute(of=UnicodeAttribute, null=True, default=list)
    allowed_tags = ListAttribute(of=UnicodeAttribute, null=True, default=list)


class LicensesParentMeta(MapAttribute):
    shape_rules = ListAttribute(of=ShapeRule, null=True, default=list)
    resource_groups = \
        ListAttribute(of=ResourceGroupAttribute, null=True, default=list)

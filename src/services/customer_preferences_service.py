...
from commons.constants import RULE_ID_ATTR
    ...
    def process_exclude_filters(self, instances_data, filters: list = None):
        ...
        for filter_ in filters:
            ...
            filter_names_to_exclude = [item.name for item in
                                       matching_instances]
            filter_excluded_count[filter_.get(RULE_ID_ATTR)] = len(
                filter_names_to_exclude)
        ...
        return result, filter_excluded_count

...
from commons.constants import BATCH_ENV_SUBMITTED_AT, BATCH_ENV_JOB_ID, \
    ...
    ENV_MODULAR_ASSUME_ROLE_ARN, ENV_MODULAR_SECRETS_SERVICE_MODE, \
    ENV_MODULAR_SDK_MONGO_URI, ENV_MODULAR_SDK_MONGO_DB_NAME, \
    ENV_MODULAR_SDK_MONGO_USER, ENV_MODULAR_SDK_MONGO_PASSWORD, \
    ENV_MODULAR_SDK_MONGO_URL, ENV_R8S_MONGODB_USER, ENV_R8S_MONGODB_PASSWORD, \
    ENV_R8S_MONGODB_URL, ENV_R8S_MONGODB_DB, ENV_MODULAR_SDK_SECRETS_BACKEND, \
    ENV_MODULAR_SDK_ASSUME_ROLE_ARN
...
ALLOWED_ENV_KEYS = (
    ...
    ENV_MODULAR_ASSUME_ROLE_ARN,
    ENV_SERVICE_MODE_S3,
    ENV_MODULAR_SECRETS_SERVICE_MODE,
    ENV_MODULAR_SDK_MONGO_URI,
    ENV_MODULAR_SDK_MONGO_USER,
    ENV_MODULAR_SDK_MONGO_PASSWORD,
    ENV_MODULAR_SDK_MONGO_URL,
    ENV_MODULAR_SDK_MONGO_DB_NAME,
    ENV_MODULAR_SDK_SECRETS_BACKEND,
    ENV_MODULAR_SDK_ASSUME_ROLE_ARN,
    ENV_R8S_MONGODB_USER,
    ENV_R8S_MONGODB_PASSWORD,
    ENV_R8S_MONGODB_URL,
    ENV_R8S_MONGODB_DB,
    "MODULAR_SDK_SERVICE_MODE",
    "MONGODB_USER",
    "MODULAR_SDK_MONGO_URI",
    "MONGODB_PASSWORD"
)

...
## [3.13.5] - 2026-06-03
* Add Python 3.14 support (`requires-python = ">=3.10,<3.15"`)
...
* Replaced pinned dependency versions with compatible ranges to allow broader Python 3.14 resolution:
  ...
  - `prettytable==3.9.0` -> `prettytable>=3.9,<4`
  - `python-dateutil==2.9.0.post0` -> `python-dateutil>=2.9,<3`
* Add `uv.lock` for reproducible builds and dependency locking

## [3.13.4] - 2026-04-10
* Update library `modular-cli-sdk` from `==3.1.2` to `==3.1.4`

## [3.13.3] - 2026-02-24
* Standardize and improve the `r8s` help text
...
* Update libraries:
  ...
  * `modular-cli-sdk` from `==2.0.0` to `==3.1.0`

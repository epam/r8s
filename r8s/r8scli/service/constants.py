...
API_APPLICATION_RABBITMQ = 'applications/rabbitmq'
API_PARENT = 'parents'
...
API_SHAPE_PRICE_SYNC = 'shapes/prices/sync'
...
API_MCP_AUTH = 'integrations/mcp/auth'
PARAM_ID = 'id'
PARAM_JOB_ID = 'job_id'
...
CLOUD_AZURE = 'AZURE'
CLOUD_GOOGLE = 'GOOGLE'
AVAILABLE_CLOUDS = (CLOUD_AWS, CLOUD_AZURE, CLOUD_GOOGLE)
...
PARAM_RABBIT_EXCHANGE = 'rabbit_exchange'
...
OS_LINUX = 'LINUX'
OS_WINDOWS = 'WINDOWS'
AVAILABLE_OS = (OS_LINUX, OS_WINDOWS)
...
PARAM_ALLOWED_TAGS = 'allowed_tags'
PARAM_ALLOWED_RESOURCE_GROUPS = 'allowed_resource_groups'
